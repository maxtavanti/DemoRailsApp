...
ActiveRecord::Schema.define(version: 20160516141057) do
  ...
  create_table "users_organizers", id: false, force: :cascade do |t|
    t.integer "user_id"
    t.integer "organizer_id"
  end

  add_index "users_organizers", ["user_id", "organizer_id"], name: "index_users_organizers_on_user_id_and_organizer_id"
